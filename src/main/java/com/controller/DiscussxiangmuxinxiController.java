...
public class DiscussxiangmuxinxiController {
    ...
    public R save(@RequestBody DiscussxiangmuxinxiEntity discussxiangmuxinxi, HttpServletRequest request){
    	discussxiangmuxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussxiangmuxinxiEntity> wrapper = new EntityWrapper<DiscussxiangmuxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussxiangmuxinxiService.selectCount(wrapper);
