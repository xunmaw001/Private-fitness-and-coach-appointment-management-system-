	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="投诉时间" prop="tousushijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian">
...
export default {
	...
	this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../ssmnt5mp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
