	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程时长" prop="kechengshizhang">
					<el-input v-model="ruleForm.kechengshizhang" placeholder="课程时长" clearable  :readonly="ro.kechengshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程时长" prop="kechengshizhang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="项目介绍" prop="xiangmujieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangmujieshao" label="项目介绍" prop="xiangmujieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xiangmujieshao"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.xiangmujieshao = this.ruleForm.xiangmujieshao.replace(reg,'../../../ssmnt5mp/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
