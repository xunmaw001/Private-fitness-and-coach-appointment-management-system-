	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="gonghao">
					<el-input v-model="ruleForm.gonghao" placeholder="商户名称" clearable  :readonly="ro.gonghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="gonghao">
					<el-input v-model="ruleForm.gonghao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
...
export default {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssmnt5mp/upload');
        } else {
