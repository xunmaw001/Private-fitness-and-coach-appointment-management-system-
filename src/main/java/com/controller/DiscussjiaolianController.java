...
public class DiscussjiaolianController {
    ...
    public R save(@RequestBody DiscussjiaolianEntity discussjiaolian, HttpServletRequest request){
    	discussjiaolian.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjiaolianEntity> wrapper = new EntityWrapper<DiscussjiaolianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjiaolianService.selectCount(wrapper);
